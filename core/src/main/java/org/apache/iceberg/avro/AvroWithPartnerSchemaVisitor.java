...
/**
 * A abstract avro schema vistor with partner type.
 * This class is for both reading and writing.
 * - When reading, need to deal with shcema evolution.
 * - When writing, the avro schema should be consistent with partner type.
 *
