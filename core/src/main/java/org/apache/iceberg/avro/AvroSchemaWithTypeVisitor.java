...
/**
 * Avro {@link Schema} visitor with partner Iceberg schema.
 * See {@link #schemaEvolution}, this class is for schema evolution reading.
 */
public abstract class AvroSchemaWithTypeVisitor<T> extends AvroWithPartnerSchemaVisitor<Type, T> {
  ...
  public Type structFieldTypeById(Type structType, int id) {
    return structType == null ? null : structType.asStructType().field(id).type();
  }
