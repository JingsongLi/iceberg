...
public class FlinkTableSource implements StreamTableSource<RowData>, ProjectableTableSource<RowData> {
  ...
  public DataStream<RowData> getDataStream(StreamExecutionEnvironment execEnv) {
    ...
    List<String> projectNames = projectedFields == null ? null : Arrays.stream(projectedFields)
        .mapToObj(project -> icebergSchema.asStruct().fields().get(project).name()).collect(Collectors.toList());
