...
public class ScanOptions implements Serializable {
  ...
  public ScanOptions(boolean caseSensitive, Long snapshotId, Long startSnapshotId,
                     Long endSnapshotId, Long asOfTimestamp, Long splitSize, Integer splitLookback,
                     Long splitOpenFileCost, String nameMapping, boolean streaming, Duration monitorInterval) {
  ...
  public ScanOptions copyWithAppendsBetween(long newStartSnapshotId, long newEndSnapshotId) {
    Long newSnapshotId = null;
    Long newAsOfTimestamp = null;
    return new ScanOptions(caseSensitive, newSnapshotId, newStartSnapshotId, newEndSnapshotId,
                           newAsOfTimestamp, splitSize, splitLookback, splitOpenFileCost, nameMapping, streaming,
                           monitorInterval);
  }

  public ScanOptions copyWithSnapshotId(long newSnapshotId) {
    Long newStartSnapshotId = null;
    Long newEndSnapshotId = null;
    Long newAsOfTimestamp = null;
    return new ScanOptions(caseSensitive, newSnapshotId, newStartSnapshotId, newEndSnapshotId,
                           newAsOfTimestamp, splitSize, splitLookback, splitOpenFileCost, nameMapping, streaming,
                           monitorInterval);
  ...
  public static final class Builder {
    ...
    private boolean streaming = STREAMING.defaultValue();
    ...
    public Builder options(Map<String, String> options) {
      ...
      this.monitorInterval = config.get(MONITOR_INTERVAL);
      return this;
    }
    ...
    public Builder enableStreamingRead() {
      this.streaming = true;
      return this;
    }

    public Builder monitorInterval(Duration newInterval) {
    ...
    public ScanOptions build() {
      ...
      return new ScanOptions(
          caseSensitive, snapshotId, startSnapshotId, endSnapshotId, asOfTimestamp, splitSize,
          splitLookback, splitOpenFileCost, nameMapping, streaming, monitorInterval);
    }
  }
}
